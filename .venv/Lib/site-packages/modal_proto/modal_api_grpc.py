...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client", server_url: str) -> None:
        ...
        self.EnvironmentGetRoles = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentGetRoles, client, server_url)
        ...
        self.FunctionCallGetInfo = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.FunctionCallGetInfo, client, server_url)
        ...
        self.SandboxGetExitSnapshot = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetExitSnapshot, client, server_url)
        ...
        self.SandboxRestoreV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxRestoreV2, client, server_url)
        self.SandboxSetName = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxSetName, client, server_url)
